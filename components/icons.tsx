...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.321l5.522.802a.563.563 0 01.311.956l-3.995 3.895a.563.563 0 00-.163.5c.023.59.13 1.767.354 2.846a.563.563 0 01-.813.623l-4.92-2.585a.563.563 0 00-.52 0l-4.92 2.585a.563.563 0 01-.813-.623c.224-1.08.33-2.256.354-2.846a.563.563 0 00-.163-.5L.16 10.689a.563.563 0 01.311-.956l5.522-.802a.563.563 0 00.475-.321L11.48 3.5z" />
  </svg>
);
...
export const TextIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 6h3M3 10h11M3 14h11M3 18h3M7 4v16M15 4h6M15 8h6M15 12h6M15 16h6M15 20h6" />
    </svg>
);
...
export const MapIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 16.382V5.618a1 1 0 00-1.447-.894L15 7m-6 10V7m0 0L3 4m6 3l6-3m6 3l-6-3" />
    </svg>
);
...
export const ClearIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l-3 3m0 0l3 3m-3-3h5.5a3.5 3.5 0 010 7H13m-2 10l-3-3m0 0l3-3m-3 3H8.5a3.5 3.5 0 010-7H11" />
    </svg>
);
